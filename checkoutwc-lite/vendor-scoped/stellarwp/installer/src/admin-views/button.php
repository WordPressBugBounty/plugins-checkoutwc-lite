...
echo \esc_attr($slug);
?>"
	data-hook-prefix="<?php 
echo \esc_attr($hook_prefix);
?>"
	data-nonce="<?php 
...
?>"
	data-request-action="<?php 
echo \esc_attr($request_action);
?>"
	data-redirect-url="<?php 
echo \esc_attr($redirect_url);
?>"
	data-installing-label="<?php 
echo \esc_attr($installing_label);
?>"
	data-installed-label="<?php 
echo \esc_attr($installed_label);
?>"
	data-activating-label="<?php 
echo \esc_attr($activating_label);
?>"
	data-activated-label="<?php 
echo \esc_attr($activated_label);
?>"
><?php 
