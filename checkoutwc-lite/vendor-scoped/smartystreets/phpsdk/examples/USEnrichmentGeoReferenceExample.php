...
use CheckoutWC\SmartyStreets\PhpSdk\US_Enrichment\Result;
use CheckoutWC\SmartyStreets\PhpSdk\US_Enrichment\Lookup;
...
class USEnrichmentGeoReferenceExample
{
    public function run()
    {
        ...
        $client = (new ClientBuilder($credentials))->buildUsEnrichmentApiClient();
