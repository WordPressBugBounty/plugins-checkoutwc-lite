...
{
    //region [ Fields ]
    public $firstFloorSqft, $secondFloorSqft, $acres, $airConditioner, $arborPergola, $assessedImprovementPercent, $assessedImprovementValue, $assessedLandValue, $assessedValue, $assessorLastUpdate, $assessorTaxrollUpdate, $atticArea, $atticFlag, $balcony, $balconyArea, $basementSqft, $basementSqftFinished, $basementSqftUnfinished, $bathHouse, $bathHouseSqft, $bathroomsPartial, $bathroomsTotal, $bedrooms, $block1, $block2, $boatAccess, $boatHouse, $boatHouseSqft, $boatLift, $bonusRoom, $breakfastNook, $breezeway, $buildingDefinitionCode, $buildingSqft, $cabin, $cabinSqft, $canopy, $canopySqft, $carport, $carportSqft, $cbsaCode, $cbsaName, $cellar, $censusBlock, $censusBlockGroup, $censusFipsPlaceCode, $censusTract, $centralVacuum, $codeTitleCompany, $combinedStatisticalArea, $communityRec, $companyFlag, $congressionalDistrict, $constructionType, $contactCity, $contactCrrt, $contactFullAddress, $contactHouseNumber, $contactMailInfoFormat, $contactMailInfoPrivacy, $contactMailingCounty, $contactMailingFips, $contactPostDirection, $contactPreDirection, $contactState, $contactStreetName, $contactSuffix, $contactUnitDesignator, $contactValue, $contactZip, $contactZip4, $courtyard, $courtyardArea, $deck, $deckArea, $deedDocumentPage, $deedDocumentBook, $deedDocumentNumber, $deedOwnerFirstName, $deedOwnerFirstName2, $deedOwnerFirstName3, $deedOwnerFirstName4, $deedOwnerFullName, $deedOwnerFullName2, $deedOwnerFullName3, $deedOwnerFullName4, $deedOwnerLastName, $deedOwnerLastName2, $deedOwnerLastName3, $deedOwnerLastName4, $deedOwnerMiddleName, $deedOwnerMiddleName2, $deedOwnerMiddleName3, $deedOwnerMiddleName4, $deedOwnerSuffix, $deedOwnerSuffix2, $deedOwnerSuffix3, $deedOwnerSuffix4, $deedSaleDate, $deedSalePrice, $deedTransactionId, $depthLinearFootage, $disabledTaxExemption, $documentTypeDescription, $drivewaySqft, $drivewayType, $effectiveYearBuilt, $elevationFeet, $elevator, $equestrianArena, $escalator, $exerciseRoom, $exteriorWalls, $familyRoom, $fence, $fenceArea, $financialHistory, $fipsCode, $fireResistanceCode, $fireSprinklersFlag, $fireplace, $fireplaceNumber, $firstName, $firstName2, $firstName3, $firstName4, $flooring, $foundation, $gameRoom, $garage, $garageSqft, $gazebo, $gazeboSqft, $golfCourse, $grainery, $grainerySqft, $greatRoom, $greenhouse, $greenhouseSqft, $grossSqft, $guesthouse, $guesthouseSqft, $handicapAccessibility, $heat, $heatFuelType, $hobbyRoom, $homeownerTaxExemption, $instrumentDate, $intercomSystem, $interestRateType2, $interiorStructure, $kennel, $kennelSqft, $landUseCode, $landUseGroup, $landUseStandard, $lastName, $lastName2, $lastName3, $lastName4, $latitude, $laundry, $leanTo, $leanToSqft, $legalDescription, $legalUnit, $lenderAddress, $lenderAddress2, $lenderCity, $lenderCity2, $lenderCode2, $lenderFirstName, $lenderFirstName2, $lenderLastName, $lenderLastName2, $lenderName, $lenderName2, $lenderSellerCarryBack, $lenderSellerCarryBack2, $lenderState, $lenderState2, $lenderZip, $lenderZip2, $lenderZipExtended, $lenderZipExtended2, $loadingPlatform, $loadingPlatformSqft, $longitude, $lot1, $lot2, $lot3, $lotSqft, $marketImprovementPercent, $marketImprovementValue, $marketLandValue, $marketValueYear, $matchType, $mediaRoom, $metroDivision, $middleName, $middleName2, $middleName3, $middleName4, $milkhouse, $milkhouseSqft, $minorCivilDivisionCode, $minorCivilDivisionName, $mobileHomeHookup, $mortgageAmount, $mortgageAmount2, $mortgageDueDate, $mortgageDueDate2, $mortgageInterestRate, $mortgageInterestRateType, $mortgageLenderCode, $mortgageRate2, $mortgageRecordingDate, $mortgageRecordingDate2, $mortgageTerm, $mortgageTerm2, $mortgageTermType, $mortgageTermType2, $mortgageType, $mortgageType2, $msaCode, $msaName, $mudRoom, $multiParcelFlag, $nameTitleCompany, $neighborhoodCode, $numberOfBuildings, $office, $officeSqft, $otherTaxExemption, $outdoorKitchenFireplace, $overheadDoor, $ownerFullName, $ownerFullName2, $ownerFullName3, $ownerFullName4, $ownerOccupancyStatus, $ownershipTransferDate, $ownershipTransferDocNumber, $ownershipTransferTransactionId, $ownershipType, $ownershipType2, $ownershipVestingRelationCode, $parcelAccountNumber, $parcelMapBook, $parcelMapPage, $parcelNumberAlternate, $parcelNumberFormatted, $parcelNumberPrevious, $parcelNumberYearAdded, $parcelNumberYearChange, $parcelRawNumber, $parcelShellRecord, $parkingSpaces, $patioArea, $phaseName, $plumbingFixturesCount, $poleStruct, $poleStructSqft, $pond, $pool, $poolArea, $poolhouse, $poolhouseSqft, $porch, $porchArea, $poultryHouse, $poultryHouseSqft, $previousAssessedValue, $priorSaleAmount, $priorSaleDate, $propertyAddressCarrierRouteCode, $propertyAddressCity, $propertyAddressFull, $propertyAddressHouseNumber, $propertyAddressPostDirection, $propertyAddressPreDirection, $propertyAddressState, $propertyAddressStreetName, $propertyAddressStreetSuffix, $propertyAddressUnitDesignator, $propertyAddressUnitValue, $propertyAddressZip4, $propertyAddressZipcode, $publicationDate, $quarter, $quarterQuarter, $quonset, $quonsetSqft, $range, $recordingDate, $roofCover, $roofFrame, $rooms, $rvParking, $safeRoom, $saleAmount, $saleDate, $sauna, $section, $securityAlarm, $seniorTaxExemption, $sewerType, $shed, $shedSqft, $silo, $siloSqft, $sittingRoom, $situsCounty, $situsState, $soundSystem, $sportsCourt, $sprinklers, $stable, $stableSqft, $storageBuilding, $storageBuildingSqft, $storiesNumber, $stormShelter, $stormShutter, $structureStyle, $study, $subdivision, $suffix, $suffix2, $suffix3, $suffix4, $sunroom, $taxAssessYear, $taxBilledAmount, $taxDelinquentYear, $taxFiscalYear, $taxJurisdiction, $taxRateArea, $tennisCourt, $topographyCode, $totalMarketValue, $township, $tractNumber, $transferAmount, $trustDescription, $unitCount, $upperFloorsSqft, $utility, $utilityBuilding, $utilityBuildingSqft, $utilitySqft, $veteranTaxExemption, $viewDescription, $waterFeature, $waterServiceType, $wetBar, $widowTaxExemption, $widthLinearFootage, $wineCellar, $yearBuilt, $zoning;
    //endregion
