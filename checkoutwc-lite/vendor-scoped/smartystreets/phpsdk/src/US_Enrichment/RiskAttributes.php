...
{
    //region [ Fields ]
    public $AGRIVALUE, $ALR_NPCTL, $ALR_VALA, $ALR_VALB, $ALR_VALP, $ALR_VRA_NPCTL, $AREA, $AVLN_AFREQ, $AVLN_ALRB, $AVLN_ALRP, $AVLN_ALR_NPCTL, $AVLN_EALB, $AVLN_EALP, $AVLN_EALPE, $AVLN_EALR, $AVLN_EALS, $AVLN_EALT, $AVLN_EVNTS, $AVLN_EXPB, $AVLN_EXPP, $AVLN_EXPPE, $AVLN_EXPT, $AVLN_EXP_AREA, $AVLN_HLRB, $AVLN_HLRP, $AVLN_HLRR, $AVLN_RISKR, $AVLN_RISKS, $AVLN_RISKV, $BUILDVALUE, $CFLD_AFREQ, $CFLD_ALRB, $CFLD_ALRP, $CFLD_ALR_NPCTL, $CFLD_EALB, $CFLD_EALP, $CFLD_EALPE, $CFLD_EALR, $CFLD_EALS, $CFLD_EALT, $CFLD_EVNTS, $CFLD_EXPB, $CFLD_EXPP, $CFLD_EXPPE, $CFLD_EXPT, $CFLD_EXP_AREA, $CFLD_HLRB, $CFLD_HLRP, $CFLD_HLRR, $CFLD_RISKR, $CFLD_RISKS, $CFLD_RISKV, $COUNTY, $COUNTYFIPS, $COUNTYTYPE, $CRF_VALUE, $CWAV_AFREQ, $CWAV_ALRA, $CWAV_ALRB, $CWAV_ALRP, $CWAV_ALR_NPCTL, $CWAV_EALA, $CWAV_EALB, $CWAV_EALP, $CWAV_EALPE, $CWAV_EALR, $CWAV_EALS, $CWAV_EALT, $CWAV_EVNTS, $CWAV_EXPA, $CWAV_EXPB, $CWAV_EXPP, $CWAV_EXPPE, $CWAV_EXPT, $CWAV_EXP_AREA, $CWAV_HLRA, $CWAV_HLRB, $CWAV_HLRP, $CWAV_HLRR, $CWAV_RISKR, $CWAV_RISKS, $CWAV_RISKV, $DRGT_AFREQ, $DRGT_ALRA, $DRGT_ALR_NPCTL, $DRGT_EALA, $DRGT_EALR, $DRGT_EALS, $DRGT_EALT, $DRGT_EVNTS, $DRGT_EXPA, $DRGT_EXPT, $DRGT_EXP_AREA, $DRGT_HLRA, $DRGT_HLRR, $DRGT_RISKR, $DRGT_RISKS, $DRGT_RISKV, $EAL_RATNG, $EAL_SCORE, $EAL_SPCTL, $EAL_VALA, $EAL_VALB, $EAL_VALP, $EAL_VALPE, $EAL_VALT, $ERQK_AFREQ, $ERQK_ALRB, $ERQK_ALRP, $ERQK_ALR_NPCTL, $ERQK_EALB, $ERQK_EALP, $ERQK_EALPE, $ERQK_EALR, $ERQK_EALS, $ERQK_EALT, $ERQK_EVNTS, $ERQK_EXPB, $ERQK_EXPP, $ERQK_EXPPE, $ERQK_EXPT, $ERQK_EXP_AREA, $ERQK_HLRB, $ERQK_HLRP, $ERQK_HLRR, $ERQK_RISKR, $ERQK_RISKS, $ERQK_RISKV, $HAIL_AFREQ, $HAIL_ALRA, $HAIL_ALRB, $HAIL_ALRP, $HAIL_ALR_NPCTL, $HAIL_EALA, $HAIL_EALB, $HAIL_EALP, $HAIL_EALPE, $HAIL_EALR, $HAIL_EALS, $HAIL_EALT, $HAIL_EVNTS, $HAIL_EXPA, $HAIL_EXPB, $HAIL_EXPP, $HAIL_EXPPE, $HAIL_EXPT, $HAIL_EXP_AREA, $HAIL_HLRA, $HAIL_HLRB, $HAIL_HLRP, $HAIL_HLRR, $HAIL_RISKR, $HAIL_RISKS, $HAIL_RISKV, $HRCN_AFREQ, $HRCN_ALRA, $HRCN_ALRB, $HRCN_ALRP, $HRCN_ALR_NPCTL, $HRCN_EALA, $HRCN_EALB, $HRCN_EALP, $HRCN_EALPE, $HRCN_EALR, $HRCN_EALS, $HRCN_EALT, $HRCN_EVNTS, $HRCN_EXPA, $HRCN_EXPB, $HRCN_EXPP, $HRCN_EXPPE, $HRCN_EXPT, $HRCN_EXP_AREA, $HRCN_HLRA, $HRCN_HLRB, $HRCN_HLRP, $HRCN_HLRR, $HRCN_RISKR, $HRCN_RISKS, $HRCN_RISKV, $HWAV_AFREQ, $HWAV_ALRA, $HWAV_ALRB, $HWAV_ALRP, $HWAV_ALR_NPCTL, $HWAV_EALA, $HWAV_EALB, $HWAV_EALP, $HWAV_EALPE, $HWAV_EALR, $HWAV_EALS, $HWAV_EALT, $HWAV_EVNTS, $HWAV_EXPA, $HWAV_EXPB, $HWAV_EXPP, $HWAV_EXPPE, $HWAV_EXPT, $HWAV_EXP_AREA, $HWAV_HLRA, $HWAV_HLRB, $HWAV_HLRP, $HWAV_HLRR, $HWAV_RISKR, $HWAV_RISKS, $HWAV_RISKV, $ISTM_AFREQ, $ISTM_ALRB, $ISTM_ALRP, $ISTM_ALR_NPCTL, $ISTM_EALB, $ISTM_EALP, $ISTM_EALPE, $ISTM_EALR, $ISTM_EALS, $ISTM_EALT, $ISTM_EVNTS, $ISTM_EXPB, $ISTM_EXPP, $ISTM_EXPPE, $ISTM_EXPT, $ISTM_EXP_AREA, $ISTM_HLRB, $ISTM_HLRP, $ISTM_HLRR, $ISTM_RISKR, $ISTM_RISKS, $ISTM_RISKV, $LNDS_AFREQ, $LNDS_ALRB, $LNDS_ALRP, $LNDS_ALR_NPCTL, $LNDS_EALB, $LNDS_EALP, $LNDS_EALPE, $LNDS_EALR, $LNDS_EALS, $LNDS_EALT, $LNDS_EVNTS, $LNDS_EXPB, $LNDS_EXPP, $LNDS_EXPPE, $LNDS_EXPT, $LNDS_EXP_AREA, $LNDS_HLRB, $LNDS_HLRP, $LNDS_HLRR, $LNDS_RISKR, $LNDS_RISKS, $LNDS_RISKV, $LTNG_AFREQ, $LTNG_ALRB, $LTNG_ALRP, $LTNG_ALR_NPCTL, $LTNG_EALB, $LTNG_EALP, $LTNG_EALPE, $LTNG_EALR, $LTNG_EALS, $LTNG_EALT, $LTNG_EVNTS, $LTNG_EXPB, $LTNG_EXPP, $LTNG_EXPPE, $LTNG_EXPT, $LTNG_EXP_AREA, $LTNG_HLRB, $LTNG_HLRP, $LTNG_HLRR, $LTNG_RISKR, $LTNG_RISKS, $LTNG_RISKV, $NRI_VER, $POPULATION, $RESL_RATNG, $RESL_SCORE, $RESL_SPCTL, $RESL_VALUE, $RFLD_AFREQ, $RFLD_ALRA, $RFLD_ALRB, $RFLD_ALRP, $RFLD_ALR_NPCTL, $RFLD_EALA, $RFLD_EALB, $RFLD_EALP, $RFLD_EALPE, $RFLD_EALR, $RFLD_EALS, $RFLD_EALT, $RFLD_EVNTS, $RFLD_EXPA, $RFLD_EXPB, $RFLD_EXPP, $RFLD_EXPPE, $RFLD_EXPT, $RFLD_EXP_AREA, $RFLD_HLRA, $RFLD_HLRB, $RFLD_HLRP, $RFLD_HLRR, $RFLD_RISKR, $RFLD_RISKS, $RFLD_RISKV, $RISK_RATNG, $RISK_SCORE, $RISK_SPCTL, $RISK_VALUE, $SOVI_RATNG, $SOVI_SCORE, $SOVI_SPCTL, $STATE, $STATEABBRV, $STATEFIPS, $STCOFIPS, $SWND_AFREQ, $SWND_ALRA, $SWND_ALRB, $SWND_ALRP, $SWND_ALR_NPCTL, $SWND_EALA, $SWND_EALB, $SWND_EALP, $SWND_EALPE, $SWND_EALR, $SWND_EALS, $SWND_EALT, $SWND_EVNTS, $SWND_EXPA, $SWND_EXPB, $SWND_EXPP, $SWND_EXPPE, $SWND_EXPT, $SWND_EXP_AREA, $SWND_HLRA, $SWND_HLRB, $SWND_HLRP, $SWND_HLRR, $SWND_RISKR, $SWND_RISKS, $SWND_RISKV, $TRACT, $TRACTFIPS, $TRND_AFREQ, $TRND_ALRA, $TRND_ALRB, $TRND_ALRP, $TRND_ALR_NPCTL, $TRND_EALA, $TRND_EALB, $TRND_EALP, $TRND_EALPE, $TRND_EALR, $TRND_EALS, $TRND_EALT, $TRND_EVNTS, $TRND_EXPA, $TRND_EXPB, $TRND_EXPP, $TRND_EXPPE, $TRND_EXPT, $TRND_EXP_AREA, $TRND_HLRA, $TRND_HLRB, $TRND_HLRP, $TRND_HLRR, $TRND_RISKR, $TRND_RISKS, $TRND_RISKV, $TSUN_AFREQ, $TSUN_ALRB, $TSUN_ALRP, $TSUN_ALR_NPCTL, $TSUN_EALB, $TSUN_EALP, $TSUN_EALPE, $TSUN_EALR, $TSUN_EALS, $TSUN_EALT, $TSUN_EVNTS, $TSUN_EXPB, $TSUN_EXPP, $TSUN_EXPPE, $TSUN_EXPT, $TSUN_EXP_AREA, $TSUN_HLRB, $TSUN_HLRP, $TSUN_HLRR, $TSUN_RISKR, $TSUN_RISKS, $TSUN_RISKV, $VLCN_AFREQ, $VLCN_ALRB, $VLCN_ALRP, $VLCN_ALR_NPCTL, $VLCN_EALB, $VLCN_EALP, $VLCN_EALPE, $VLCN_EALR, $VLCN_EALS, $VLCN_EALT, $VLCN_EVNTS, $VLCN_EXPB, $VLCN_EXPP, $VLCN_EXPPE, $VLCN_EXPT, $VLCN_EXP_AREA, $VLCN_HLRB, $VLCN_HLRP, $VLCN_HLRR, $VLCN_RISKR, $VLCN_RISKS, $VLCN_RISKV, $WFIR_AFREQ, $WFIR_ALRA, $WFIR_ALRB, $WFIR_ALRP, $WFIR_ALR_NPCTL, $WFIR_EALA, $WFIR_EALB, $WFIR_EALP, $WFIR_EALPE, $WFIR_EALR, $WFIR_EALS, $WFIR_EALT, $WFIR_EVNTS, $WFIR_EXPA, $WFIR_EXPB, $WFIR_EXPP, $WFIR_EXPPE, $WFIR_EXPT, $WFIR_EXP_AREA, $WFIR_HLRA, $WFIR_HLRB, $WFIR_HLRP, $WFIR_HLRR, $WFIR_RISKR, $WFIR_RISKS, $WFIR_RISKV, $WNTW_AFREQ, $WNTW_ALRA, $WNTW_ALRB, $WNTW_ALRP, $WNTW_ALR_NPCTL, $WNTW_EALA, $WNTW_EALB, $WNTW_EALP, $WNTW_EALPE, $WNTW_EALR, $WNTW_EALS, $WNTW_EALT, $WNTW_EVNTS, $WNTW_EXPA, $WNTW_EXPB, $WNTW_EXPP, $WNTW_EXPPE, $WNTW_EXPT, $WNTW_EXP_AREA, $WNTW_HLRA, $WNTW_HLRB, $WNTW_HLRP, $WNTW_HLRR, $WNTW_RISKR, $WNTW_RISKS, $WNTW_RISKV;
    //endregion
