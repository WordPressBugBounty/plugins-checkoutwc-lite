...
use CheckoutWC\Predis\Response\ServerException;
use CheckoutWC\Symfony\Component\Cache\Traits\RedisClusterProxy;
use CheckoutWC\Symfony\Component\Cache\Traits\RedisProxy;
...
class RedisStore implements SharedLockStoreInterface
{
    ...
    {
        if (!$redis instanceof \Redis && !$redis instanceof \RedisArray && !$redis instanceof \RedisCluster && !$redis instanceof \CheckoutWC\Predis\ClientInterface && !$redis instanceof RedisProxy && !$redis instanceof RedisClusterProxy) {
    ...
    private function evaluate(string $script, string $resource, array $args)
    {
        ...
        \assert($this->redis instanceof \CheckoutWC\Predis\ClientInterface);
        try {
