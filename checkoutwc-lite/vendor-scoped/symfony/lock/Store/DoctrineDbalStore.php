...
use CheckoutWC\Doctrine\DBAL\Configuration;
use CheckoutWC\Doctrine\DBAL\Connection;
use CheckoutWC\Doctrine\DBAL\DriverManager;
use CheckoutWC\Doctrine\DBAL\Exception as DBALException;
use CheckoutWC\Doctrine\DBAL\Exception\TableNotFoundException;
use CheckoutWC\Doctrine\DBAL\ParameterType;
use CheckoutWC\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use CheckoutWC\Doctrine\DBAL\Schema\Schema;
use CheckoutWC\Doctrine\DBAL\Tools\DsnParser;
...
class DoctrineDbalStore implements PersistingStoreInterface
{
    ...
    private function getCurrentTimestampStatement(): string
    {
        ...
        switch (\true) {
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\MySQL57Platform:
                return 'UNIX_TIMESTAMP()';
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\SqlitePlatform:
                return 'strftime(\'%s\',\'now\')';
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return 'CAST(EXTRACT(epoch FROM NOW()) AS INT)';
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\OraclePlatform:
                return '(SYSDATE - TO_DATE(\'19700101\',\'yyyymmdd\'))*86400 - TO_NUMBER(SUBSTR(TZ_OFFSET(sessiontimezone), 1, 3))*3600';
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \CheckoutWC\Doctrine\DBAL\Platforms\SQLServer2012Platform:
