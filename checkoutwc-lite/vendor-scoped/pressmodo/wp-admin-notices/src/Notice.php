...
class Notice
{
     ...
     * @var array
     */
    private $options = array('scope' => 'global', 'type' => 'info', 'alt_style' => \false, 'capability' => 'edit_theme_options', 'option_prefix' => 'pressmodo_notice_dismissed', 'screens' => array(), 'dismissible' => \true, 'mode' => 'regular');
    /**
     ...
     * @var array
     */
    private $allowed_types = array('info', 'success', 'error', 'warning');
    /**
    ...
    public function the_notice()
    {
        ...
        printf(
            ...
            'pressmodo-notice-' . esc_attr($this->id),
            // The ID.
    ...
    public function get_classes()
    {
        ...
        if (!$this->options['dismissible']) {
            if (($key = array_search('is-dismissible', $classes, \true)) !== \false) {
                unset($classes[$key]);
            }
        }
