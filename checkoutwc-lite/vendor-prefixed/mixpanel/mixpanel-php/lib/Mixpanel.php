 ...
 * @license Apache-2.0
 *
 * Modified by Clifton Griffin on 11-April-2025 using {@see https://github.com/BrianHenryIE/strauss}.
 */
...
/**
 * This is the main class for the CheckoutWC_Mixpanel PHP Library which provides all of the methods you need to track events,
 ...
 * Consumers. The "CurlConsumer" is used by default which will send the messages to CheckoutWC_Mixpanel using forked cURL processes.
 * You can implement your own custom Consumer to customize how a message is sent to CheckoutWC_Mixpanel. This can be useful when
 * you want to put messages onto a distributed queue (such as ActiveMQ or Kestrel) instead of writing to CheckoutWC_Mixpanel in
 * the user thread.
 *
 * Options
 * -------------
 ...
 * -------------
 *
 * $mp = CheckoutWC_Mixpanel::getInstance("MY_TOKEN");
 *
 * $mp->track("My Event");
 *
 ...
 * -------------
 *
 * $mp = CheckoutWC_Mixpanel::getInstance("MY_TOKEN", array("use_ssl" => false));
 *
 ...
 *
 */
class CheckoutWC_Mixpanel extends Base_MixpanelBase {
    ...
    /**
     * Instances' list of the CheckoutWC_Mixpanel class (for singleton use, splitted by token)
     * @var CheckoutWC_Mixpanel[]
     */
    private static $_instances = array();
    

    /**
     * Instantiates a new CheckoutWC_Mixpanel instance.
     * @param $token
     * @param array $options
     */
    ...
    /**
     * Returns a singleton instance of CheckoutWC_Mixpanel
     * @param $token
     * @param array $options
     * @return CheckoutWC_Mixpanel
     */
    public static function getInstance($token, $options = array()) {
        if(!isset(self::$_instances[$token])) {
            self::$_instances[$token] = new CheckoutWC_Mixpanel($token, $options);
        }
    ...
    /**
     * Add an array representing a message to be sent to CheckoutWC_Mixpanel to the in-memory queue.
     * @param array $message
     */
    ...
    /**
     * Add an array representing a list of messages to be sent to CheckoutWC_Mixpanel to a queue.
     ...
     * overwritten. NOTE: Registered properties are only persisted for the life of the CheckoutWC_Mixpanel class instance.
     ...
     * they will be overwritten. NOTE: Registered properties are only persisted for the life of the CheckoutWC_Mixpanel class
     * instance.
     ...
     *
     * If any of the properties have already been registered,
     * they will NOT be overwritten. NOTE: Registered properties are only persisted for the life of the CheckoutWC_Mixpanel class
     * instance.
     * @param array $props_and_vals
     */
